...
public class BayesianNetworkGenerator {
	...
	public static void main(String[] args) {
		try {
			...
			//This Bayes Network K2 learning algorithm uses a hill climbing algorithm restricted by an order on the variables.
			//this will build the structure of the network and add parent relationships to corresponding diseases for each symptom
			SearchAlgorithm searchAlgorithm=new K2();

			nb.setSearchAlgorithm(searchAlgorithm);
			System.out.println("building classifier");

			//generates the bayesnet classifier using the dataset as instances and K2
